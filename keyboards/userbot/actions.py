...
def get_change_image_keyboard(language_code: str, current_image_id: str) -> InlineKeyboardMarkup:
    ...
    builder.row(types.InlineKeyboardButton(text=lex['back_button'], callback_data="cancel_change"))
...
def get_change_server_keyboard(language_code: str, current_server_id: str, tariff_id: str, admin_mode: bool = False) -> InlineKeyboardMarkup:
    ...
    builder.row(types.InlineKeyboardButton(text=lex['back_button'], callback_data=cancel_callback))
    return builder.as_markup()
...
def get_transfer_confirmation_keyboard(language_code, container_id):
    lex = LEXICON.get(language_code, LEXICON['ru'])
    builder = InlineKeyboardBuilder()
    builder.row(types.InlineKeyboardButton(text=lex['transfer_confirm_button'], callback_data=f"confirm_transfer:{container_id}"))
    builder.row(types.InlineKeyboardButton(text=lex['cancel_button'], callback_data="cancel_change"))
    return builder.as_markup()
